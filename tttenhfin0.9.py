...
def game2():
    ...
    def checkAll(char):
        ...
        #elif project_board[0] != 1 and project_board[1] != 2 and project_board[2] != 3 and project_board[3] !=4 and project_board[4] !=   5 and project_board[5] !=6 and project_board[6] !=7 and project_board[7]!=8 and project_board[8]!=9 :
        #    print('Tie')
